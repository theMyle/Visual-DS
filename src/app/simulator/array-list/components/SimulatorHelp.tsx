        ...
        <div className="sim-help-overlay" onClick={onClose}>
            <div className="sim-help-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="sim-help-body">
                    <div className="sim-help-icon">{slide.icon}</div>
                ...
                <div className="sim-help-footer">
                    <button className="sim-help-nav" onClick={prev} disabled={isFirst} aria-label="Previous slide">‹</button>
                    ...
                    <button className="sim-help-nav" onClick={next} disabled={isLast} aria-label="Next slide">›</button>
                </div>
