...
export default function SimulationArray() {
    ...
    const initialEditorCode = [
        ...
        "",
        "Array {",
        "  get(index)                  - Read the item at an index.",
        ...
        "  removeAt(index)             - Remove the item at a specific index.",
        "  removeBack()                - Remove the last item in the array.",
        "  removeFront()               - Remove the first item in the array.",
